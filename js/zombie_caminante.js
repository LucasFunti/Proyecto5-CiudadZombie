...
ZombieCaminante.prototype.mover = function() {
  ...
  if ((this.x < this.rangoMov) || (this.x > this.rangoMov)){
    this.velocidad *= -1;
  }
  // Si sobrepasa el rangoY, lo manda al centro entre ambos rangos
  if ((this.y < this.rangoMov) || (this.y > this.rangoMov)) {
    this.y = this.rangoMov + (this.rangoMov)/2;
  }
...
ZombieCaminante.prototype.atacar = function(jugador) {
    jugador.perderVida(jugador.vidas-1);
}
