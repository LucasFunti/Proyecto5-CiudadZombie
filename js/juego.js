...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/bache.png',150,150,30,30,1),
    new Obstaculo('imagenes/bache.png',765,450,30,30,1),
    new Obstaculo('imagenes/bache.png',845,450,30,30,1),
    new Obstaculo('imagenes/bache.png',150,150,30,30,1),
    new Obstaculo('imagenes/valla_vertical.png',400,480,30,30,1),
    new Obstaculo('imagenes/valla_vertical.png',400,460,30,30,1),
    new Obstaculo('imagenes/valla_vertical.png',400,440,30,30,1),
    new Obstaculo('imagenes/valla_vertical.png',400,420,30,30,1),
    new Obstaculo('imagenes/valla_horizontal.png',150,150,30,30,1)
  ...
  enemigos: [
    new ZombieConductor('imagenes/tren_horizontal.png', 400, 322, 90, 30, 1, this.anchoCanvas,'h'),
    new ZombieConductor ('imagenes/tren_vertical.png', 644, 0, 30, 90, 1,this.altoCanvas,'v'),
    new ZombieConductor('imagenes/tren_vertical.png', 678, 0, 30, 90, 1 ,this.altoCanvas,'v'),
    new ZombieCaminante('imagenes/zombie1.png', 900, 50, 10, 10, 3, this.anchoCanvas),
    new ZombieCaminante('imagenes/zombie2.png', 900, 150, 10, 10, 2, this.anchoCanvas),
    new ZombieCaminante('imagenes/zombie3.png', 900, 200, 10, 10, 3, this.anchoCanvas),
    new ZombieCaminante('imagenes/zombie4.png', 900, 300, 10, 10, 2, this.anchoCanvas)
...
Juego.capturarMovimiento = function(tecla) {
  ...
  if (tecla == 'izq') {
    movX = -velocidad;
    mov = 'imagenes/auto_rojo_izquierda.png';
    ancho = 30;
    alto = 15;
  }
  if (tecla == 'arriba') {
    movY = -velocidad;
    mov = 'imagenes/auto_rojo_arriba.png';
    ancho = 15;
    alto = 30;
  }
  if (tecla == 'der') {
    movX = velocidad;
    mov = 'imagenes/auto_rojo_derecha.png';
    ancho = 30;
    alto = 15;
  }
  if (tecla == 'abajo') {
    movY = velocidad;
    mov = 'imagenes/auto_rojo_abajo.png';
    ancho = 15;
    alto = 30;
  }
  ...
  if (this.chequearColisiones(movX + this.jugador.x, movY + this.jugador.y)) {
    ...
    de sus metodos  */
    /* COMPLETAR */
    this.jugador.sprite = mov;
    this.jugador.ancho = ancho;
    this.jugador.alto = alto;
...
Juego.dibujar = function() {
  ...
  /*LINEA DE META */
  Dibujante.dibujarRectangulo('black', 760, 500, 126, 8);
  Dibujante.dibujarRectangulo('white', 760, 500, 126, 2);
  Dibujante.dibujarRectangulo('white', 760, 506, 126, 2);
...
Juego.moverEnemigos = function() {
  ...
  this.enemigos.forEach(function(enemigo) {
    /* Completar */
    enemigo.mover(enemigo.velocidad);
